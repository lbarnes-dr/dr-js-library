...
export default function DropIn({
    ...
    const render = () => {
        ...
        if (app.digitalRiver && placeholder) {
            try {
                ...
                console.log('CREATE DROPIN WITH', configuration)
    ...
    }, [flow, showSavePaymentAgreement, showComplianceSection, showTermsOfSaleDisclosure, usage, buttonType, buttonText]);
